...
#'@title loadDataArm
#'@description Connects data input arm to program, providing essential 
#'information and the main execution function. 
#'@param mainFunction The main execution function for the arm. 
...
#'@param arms The list containing all DataArm objects for the 
#'study.
#'@param title character string. The one word description of 
...
#'@param description The description of the data input arm to 
#'be used as a main menu option. (ex: "Process drug screen data")
#'@param scriptFile A file providing the script where the 
